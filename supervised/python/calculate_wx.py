...
times = [i for i in range(s.shape[1])]
DATANUM = s.shape[0]
...
plt.show()
plt.subplot(3, 1, 1)
plt.plot(number, xW[999], color='r', lw=2)
plt.plot(number, xW[7424], color='g', lw=2)
plt.plot(number, xW[9000], color='b', lw=2)
plt.subplot(3, 1, 2)
plt.plot(number, xW[6002], color='r', lw=2)
plt.plot(number, xW[7424], color='g', lw=2)
plt.plot(number, xW[9000], color='b', lw=2)
